...
<script type="text/javascript">
	function logout(){
		location.href="${pageContext.request.contextPath}/j_spring_security_logout?flag=manager";
	}
</script>
</head>
<!-- END HEAD -->
...
<body class="page-header-fixed page-quick-sidebar-over-content page-style-square"> 
	...
	<div class="page-header navbar navbar-fixed-top">
		...
		<div class="page-header-inner">
			...
			<div class="page-logo">
<!-- 				<a href="index.html"> -->
				 <img src="${pageContext.request.contextPath}/images/index/logo.png" alt="logo" style="width: 150px;margin-top:-10px;margin-left: -20px;" class="logo-default"/>
<!-- 					<span style="font: 16px;color: red;">ZXtech</span> -->
<!-- 				</a> -->
...
<!-- 												<img -->
<%-- 												src="${pageContext.request.contextPath}/bootstrap/assets/admin/layout3/img/avatar2.jpg" --%>
...
<!-- 									<li><a href="inbox.html?a=view"> <span class="photo"> -->
<!-- 												<img -->
<%-- 												src="${pageContext.request.contextPath}/bootstrap/assets/admin/layout3/img/avatar3.jpg" --%>
<!-- 												class="img-circle" alt=""> -->
...
<!-- 									<li><a href="inbox.html?a=view"> <span class="photo"> -->
<!-- 												<img -->
<%-- 												src="${pageContext.request.contextPath}/bootstrap/assets/admin/layout3/img/avatar1.jpg" --%>
<!-- 												class="img-circle" alt=""> -->
...
<!-- 						</ul></li> -->
					...
					<li class="dropdown dropdown-user"><a href="#"
						...
						data-hover="dropdown" data-close-others="true"> 
							<img alt="" class="img-circle" id="photoName" src="" />
							<span class="username username-hide-on-mobile"> <%=AuthDetailUtil.getNickName() %> </span> 
...
<!-- 									Lock Screen -->
<!-- 							</a></li> -->
<!-- 							<li><a href="javascript:void(logout());"> <i class="icon-key"></i> Log -->
<!-- 									Out -->
<!-- 							</a></li> -->
<!-- 						</ul> -->
						</li>
					...
					<li class="dropdown dropdown-quick-sidebar-toggler"><a
						href="javascript:void(logout());" class="dropdown-toggle"> <i
							class="icon-logout"></i>
					</a></li>
...
<!-- 							class="title">Page Layouts</span> <span class="arrow "></span> -->
<!-- 					</a> -->
<!-- 						<ul class="sub-menu"> -->
<!-- 							<li><a href="layout_horizontal_sidebar_menu.html"> -->
<!-- 									Horizontal & Sidebar Menu</a></li> -->
<!-- 							<li><a href="index_horizontal_menu.html"> Dashboard & -->
<!-- 									Mega Menu</a></li> -->
<!-- 							<li><a href="layout_horizontal_menu1.html"> Horizontal -->
<!-- 									Mega Menu 1</a></li> -->
<!-- 							<li><a href="layout_horizontal_menu2.html"> Horizontal -->
<!-- 									Mega Menu 2</a></li> -->
<!-- 							<li><a href="layout_fontawesome_icons.html"> <span -->
<!-- 									class="badge badge-roundless badge-danger">new</span>Layout -->
<!-- 									with Fontawesome Icons -->
<!-- 							</a></li> -->
<!-- 							<li><a href="layout_glyphicons.html"> Layout with -->
<!-- 									Glyphicon</a></li> -->
<!-- 							<li><a href="layout_full_height_portlet.html"> <span -->
<!-- 									class="badge badge-roundless badge-success">new</span>Full -->
<!-- 									Height Portlet -->
<!-- 							</a></li> -->
<!-- 							<li><a href="layout_full_height_content.html"> <span -->
<!-- 									class="badge badge-roundless badge-warning">new</span>Full -->
<!-- 									Height Content -->
<!-- 							</a></li> -->
<!-- 							<li><a href="layout_search_on_header1.html"> Search Box -->
<!-- 									On Header 1</a></li> -->
<!-- 							<li><a href="layout_search_on_header2.html"> Search Box -->
<!-- 									On Header 2</a></li> -->
<!-- 							<li><a href="layout_sidebar_search_option1.html"> -->
<!-- 									Sidebar Search Option 1</a></li> -->
<!-- 							<li><a href="layout_sidebar_search_option2.html"> -->
<!-- 									Sidebar Search Option 2</a></li> -->
<!-- 							<li><a href="layout_sidebar_reversed.html"> <span -->
<!-- 									class="badge badge-roundless badge-warning">new</span>Right -->
<!-- 									Sidebar Page -->
<!-- 							</a></li> -->
...
<!-- 							<li><a href="ui_confirmations.html"> Popover -->
<!-- 									Confirmations</a></li> -->
<!-- 							<li><a href="ui_icons.html"> <span -->
<!-- 									class="badge badge-roundless badge-danger">new</span>Font Icons -->
<!-- 							</a></li> -->
...
<!-- 									class="badge badge-roundless badge-danger">new</span>Tree View -->
<!-- 							</a></li> -->
<!-- 							<li><a href="ui_page_progress_style_1.html"> <span -->
<!-- 									class="badge badge-roundless badge-warning">new</span>Page -->
<!-- 									Progress Bar -->
<!-- 							</a></li> -->
...
<!-- 									class="badge badge-roundless badge-danger">new</span>Alerts & -->
<!-- 									Dialogs API -->
<!-- 							</a></li> -->
...
<!-- 									class="badge badge-roundless badge-success">new</span>Date -->
<!-- 									Paginator -->
<!-- 							</a></li> -->
...
<!-- 						<a href="angularjs" target="_blank"> <i -->
<!-- 							class="icon-paper-plane"></i> <span class="title"> -->
...
<!-- 									class="badge badge-roundless badge-danger">new</span>Image -->
<!-- 									Cropping -->
<!-- 							</a></li> -->
...
<!-- 							<li><a href="table_responsive.html"> Responsive -->
<!-- 									Datatables</a></li> -->
...
<!-- 									class="badge badge-roundless badge-danger">new</span>New -->
<!-- 									Portlets #1 -->
<!-- 							</a></li> -->
...
<!-- 									class="icon-paper-plane"></i> <span class="badge badge-warning">2</span> -->
<!-- 									New Timeline -->
<!-- 							</a></li> -->
<!-- 							<li><a href="page_todo.html"> <i class="icon-check"></i> -->
<!-- 									Todo -->
<!-- 							</a></li> -->
<!-- 							<li><a href="inbox.html"> <i class="icon-envelope"></i> -->
<!-- 									<span class="badge badge-danger">4</span>Inbox -->
<!-- 							</a></li> -->
...
<!-- 									Profile -->
<!-- 							</a></li> -->
<!-- 							<li><a href="extra_profile_old.html"> <i -->
<!-- 									class="icon-user"></i> Old User Profile -->
<!-- 							</a></li> -->
<!-- 							<li><a href="extra_faq.html"> <i class="icon-question"></i> -->
<!-- 									FAQ -->
<!-- 							</a></li> -->
<!-- 							<li><a href="page_calendar.html"> <i -->
<!-- 									class="icon-calendar"></i> <span class="badge badge-danger">14</span>Calendar -->
<!-- 							</a></li> -->
<!-- 							<li><a href="page_timeline_old.html"> <i -->
<!-- 									class="icon-clock"></i> <span class="badge badge-info">4</span>Old -->
<!-- 									Timeline -->
<!-- 							</a></li> -->
<!-- 							<li><a href="page_coming_soon.html"> <i -->
<!-- 									class="icon-flag"></i> Coming Soon -->
<!-- 							</a></li> -->
...
<!-- 									</a> -->
<!-- 										<ul class="sub-menu"> -->
<!-- 											<li><a href="#"><i class="icon-power"></i> Sample -->
<!-- 													Link 1</a></li> -->
<!-- 											<li><a href="#"><i class="icon-paper-plane"></i> -->
<!-- 													Sample Link 1</a></li> -->
<!-- 											<li><a href="#"><i class="icon-star"></i> Sample -->
<!-- 													Link 1</a></li> -->
<!-- 										</ul></li> -->
<!-- 									<li><a href="#"><i class="icon-camera"></i> Sample -->
<!-- 											Link 1</a></li> -->
<!-- 									<li><a href="#"><i class="icon-link"></i> Sample Link -->
<!-- 											2</a></li> -->
<!-- 									<li><a href="#"><i class="icon-pointer"></i> Sample -->
<!-- 											Link 3</a></li> -->
<!-- 								</ul></li> -->
...
<!-- 							</a> -->
<!-- 								<ul class="sub-menu"> -->
<!-- 									<li><a href="#"><i class="icon-tag"></i> Sample Link 1</a> -->
<!-- 									</li> -->
<!-- 									<li><a href="#"><i class="icon-pencil"></i> Sample -->
<!-- 											Link 1</a></li> -->
<!-- 									<li><a href="#"><i class="icon-graph"></i> Sample Link -->
<!-- 											1</a></li> -->
<!-- 								</ul></li> -->
...
<!-- 					</li> -->
<!-- 					<li><a href="javascript:;"> <i class="icon-logout"></i> <span -->
<!-- 							class="title">Quick Sidebar</span> <span class="arrow "></span> -->
<!-- 					</a> -->
<!-- 						<ul class="sub-menu"> -->
<!-- 							<li><a href="quick_sidebar_push_content.html"> Push -->
<!-- 									Content</a></li> -->
<!-- 							<li><a href="quick_sidebar_over_content.html"> Over -->
<!-- 									Content</a></li> -->
<!-- 							<li><a href="quick_sidebar_over_content_transparent.html"> -->
<!-- 									Over Content & Transparent</a></li> -->
<!-- 							<li><a href="quick_sidebar_on_boxed_layout.html"> Boxed -->
<!-- 									Layout</a></li> -->
<!-- 						</ul></li> -->
...
<!-- 					</a> -->
<!-- 						<ul class="sub-menu"> -->
<!-- 							<li><a href="email_newsletter.html"> Responsive -->
<!-- 									Newsletter<br> Email Template -->
<!-- 							</a></li> -->
...
<!--     			</iframe> -->
	...
	<div class="page-footer">
		<div class="page-footer-inner">2017 &copy; zxtech.</div>
	...
	<script src="${pageContext.request.contextPath}/js/initMenu.js" type="text/javascript"></script>
	<script>
		var photoNamePath = "";
		var photoName = '<%=AuthDetailUtil.getPhotoName() %>';
		if(photoName == null || photoName == "" || photoName == "null"){
			photoName = "nopersimage.jpg";
			photoNamePath = server+"/images/"+photoName;
		}else{
			photoNamePath = "/lmsFiles/userPhoto/"+photoName;
		}
		$("#photoName").attr("src", photoNamePath);
	</script>
	<!-- END BASE PLUGINS -->
