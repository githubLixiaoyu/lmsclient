...
;(function($){
	...
	$.fn.bgStretcher = function(settings){
		...
		function _genHtml(body_content){
			...
			body_content.each(function(){
				...
				cur_bgstretcher.children('.bgstretcher-page').css({'position': 'fixed', 'z-index': 3, 'top': '30%', 'right': "0px"});
			});
	...
	$.fn.bgStretcher.pagination = function(){
		...
		if (l > 0) {
			output += '<ul>';
				for (i = 0; i < l; i++){
					output += '<li><a href="javascript:;"><img src="images/index/touming.png"/></a></li>';
				}
			output += '</ul>';
