								...
								<table id="listQuestionTable" class="table table-hover">
									<thead>
										<tr>
											...
											<th width="55%"><fmt:message key="lms.questionContent"/></th>
											<th width="15%"><fmt:message key="lms.questionCategory"/></th>
											<th width="15%"><fmt:message key="lms.questionDifficulty"/></th>
											<th width="10%"><span><fmt:message key="lms.score"/><input id="score" name="score" class="form-control input-sm select2" type="text" style="width: 60px;float: left;"/></span></th>
										</tr>
									</thead>
									<tbody>
									</tbody>
...
<sitemesh:script>
<script src="${pageContext.request.contextPath}/js/teacher/newtestpaper/newtestpaperQuestionEdit_dlg.js?version=${version}"></script>
...
//改成相同分数
var changeSameScoreConfirmMsg = '<fmt:message key="lms.changeSameScoreConfirmMsg"/>';
//请选择
