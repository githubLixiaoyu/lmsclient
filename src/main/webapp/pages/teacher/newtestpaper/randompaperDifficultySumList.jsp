...
<html lang="en">
<head>
	<title><fmt:message key="lms.questionInfoList"/></title>
	<style type="text/css">
		#searchForm td {
			white-space:nowrap; 
		}
...
<div class="modal fade" id="portlet-upload-dlg" tabindex="-1" role="basic" aria-hidden="true">
	...
	<div class="row">
		<div class="col-md-12">
						...
						<form id="searchForm" action="#">
							<div class="form-body">
								<div class="table-responsive">
									<input id="typeid" name="typeid" type="hidden" value="<%=request.getParameter("typeid")%>"/>
									<input id="paperid" name="paperid" type="hidden" value="<%=request.getParameter("paperid")%>"/>
									<table class="table">
										<tbody>
											<tr>
												...
												<td class="formlable" width="8.5%">
													<fmt:message key="lms.knowledge"/>
                                                </td>
                                                <td class="formbody" width="11.5%">
                                                    <input id="knowledgepoint" name="knowledgepoint" class="form-control input-sm select2" type="text" style="width: 180px;"/>
                                                </td>
			...
			<div class="portlet box blue-hoki nomargin ">
				<div class="portlet-title">
					<div class="caption" id="typeCaption">(<%=request.getParameter("name")%>)<fmt:message key="lms.questionInfoList"/>
					</div>
					<div class="actions">
								...
								<table id="listTable" class="table table-hover">
									<thead>
										<tr>
											...
											<th width="15%"><fmt:message key="lms.knowledge"/></th>
											<th width="50%"><fmt:message key="lms.distributionDetail"/></th>
										</tr>
									</thead>
									<tbody>
									</tbody>
...
<sitemesh:script>
<script src="${pageContext.request.contextPath}/js/teacher/newtestpaper/randompaperDifficultySumList.js?version=${version}"></script>
<script>
//全部
