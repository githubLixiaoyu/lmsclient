										...
										<tbody>
											<tr>
                                                ...
                                                <td class="formbody" width="11.5%">
                                                    <input id="mileStoneName" name="mileStoneName" class="form-control" type="text" style="width: 200px;"/>
                                                </td>
												<td class="formlable" width="8.5%">
													<fmt:message key="lms.examCategory"/>
                                                </td>
                                                <td class="formbody" width="11.5%">
                                                    <input id="testTemplateId" name="testTemplateId" class="form-control input-sm select2" type="text" style="width: 200px;"/>
                                                </td>
												<td class="formlable" width="8.5%">
 											...
 											<tr>
                                                ...
                                                <td class="formbody" width="11.5%">
                                                    <input id="statusTypeId" name="statusTypeId" class="form-control input-sm select2" type="text" style="width: 200px;"/>
                                                </td>
				...
				<div class="portlet-title">
					...
					<div class="actions">
						...
						<button type="button" id="removeBtn" class="btn btn-success">
							<i class="fa fa-trash-o"></i> <fmt:message key="lms.forbidden"/>
						</button>
...
<sitemesh:script>
<script src="${pageContext.request.contextPath}/js/teacher/vrnewexam/testInstanceRequestList.js?version=${version}"></script>
<script>
//考试类型 定期考试
