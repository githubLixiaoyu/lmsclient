										...
										<tbody>
											<tr>
                                                ...
                                                <td class="formbody" width="11.5%">
                                                    <input id="mileStoneName" name="mileStoneName" class="form-control" type="text" style="width: 180px;"/>
                                                    <input id="statusTypeId" name="statusTypeId" type="hidden" value="1"/>
                                                </td>
												<td class="formlable" width="8.5%">
													<fmt:message key="lms.examCategory"/>
                                                </td>
                                                <td class="formbody" width="11.5%">
                                                    <input id="testTemplateId" name="testTemplateId" class="form-control input-sm select2" type="text" style="width: 180px;"/>
                                                </td>
...
<sitemesh:script>
<script src="${pageContext.request.contextPath}/js/teacher/vrnewexam/paperList_dlg.js?version=${version}"></script>
<script>
	//获取父页面对象
