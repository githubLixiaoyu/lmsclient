...
<div class="modal fade" id="portlet-upload-dlg" tabindex="-1" role="basic" aria-hidden="true">
	...
	<div class="row">
		<div class="col-md-12">
										...
										<tbody>
											<tr>
                                                ...
                                                <td class="formbody" width="11.5%">
                                                    ...
                                                    <input id="testInstanceRequestId" name="testInstanceRequestId" type="hidden"/>
                                                </td>
												<td class="formlable" width="8.5%">
			...
			<div class="portlet box blue-hoki nomargin ">
				<div class="portlet-title">
					<div class="caption" id="typeCaption"><fmt:message key="lms.unallocatedUserList"/>
					</div>
					<div class="actions">
...
<sitemesh:script>
<script src="${pageContext.request.contextPath}/js/teacher/vrnewexam/newexamAuthoruserEdit_dlg.js?version=${version}"></script>
