				...
				<input id="examid" name="examid" type="hidden" value="<%=request.getParameter("examid")%>">
					<table id="formTable">
						<tr>
							...
							<td><input class="form-control" id="examname" name="examname" type="text" style="width: 200px;" maxlength="100"></td>
						...
						<tr>
							...
							<td><input class="form-control form-control-inline date-picker" id="starttime" name="starttime" type="text" style="width: 200px;"></td>
							<td><label><fmt:message key="lms.endDate"/>:<span style="color:red;padding-left:5px;">*</span></label></td>
							<td><input class="form-control form-control-inline date-picker" id="endtime" name="endtime" type="text" style="width: 200px;"></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>
								<input class="form-control" id="categoryname" name="categoryname" type="text" style="width: 200px;" disabled="disabled">
								<input id="categoryid" name="categoryid" type="hidden">
							</td>
							<td><label><fmt:message key="lms.testSort"/>:</label></td>
							<td><input class="form-control" id="examKhzl" name="examKhzl" type="text" style="" maxlength="100"></td>
						</tr>
						<tr>
							<td><label><fmt:message key="lms.testTarget"/>:</label></td>
							<td><input class="form-control" id="examKhxm" name="examKhxm" type="text" style="width: 200px;" maxlength="100"></td>
							<td><label><fmt:message key="lms.testTime"/>:<span style="color:red;padding-left:5px;">*</span></label></td>
							<td><input class="form-control" id="examtime" name="examtime" type="text" style="width: 100px;float: left;">(<fmt:message key="lms.min"/>)
							</td>
						</tr>
						<tr>
...
<!-- 							</td> -->
<!-- 							<td> -->
								<input class="form-control" id="examscore" name="examscore" type="text" style="width: 100px;float: left;" disabled="disabled">
						...
						<tr>
							...
							<td>
								<input class="form-control" id="definedpassscore" name="definedpassscore" type="text" style="width: 100px;">
						...
						<tr>
							<td><label><fmt:message key="lms.showPoint"/>:<span style="color:red;padding-left:5px;">*</span></label></td>
							<td colspan="2">
								<div class="radio-list" style="float: left;">
									<label class="radio-inline">
										<input id="showpoint1" name="showpoint" type="radio" value="1" checked="checked"><fmt:message key="lms.yes"/>
									</label>
									<label class="radio-inline">
										<input id="showpoint2" name="showpoint" type="radio" value="0"><fmt:message key="lms.no"/>
									</label>
								</div>
							</td>
							<td><fmt:message key="lms.showPointNoteInfo"/></td>
						</tr>
						<tr>
...
<script src="${pageContext.request.contextPath}/js/teacher/newexam/newExamInfoEdit.js?version=${version}"></script>
<script>
//考试类型 定期考试
