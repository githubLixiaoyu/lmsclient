		...
		<div class="col-md-12" style="overflow-y: auto;overflow-x: hidden; height: 350px">
			...
			<div class="portlet box blue-hoki">
				...
				<div class="portlet-body">
					...
					<input type="hidden" id="parentpoint" name="parentpoint" value="0"/>
					<table>
						<tr id="categoryTd">
						...
						<tr>
							<td><label><fmt:message key="lms.knowledgeName"/>:</label></td>
							<td><input class="form-control" id="pointname" name="pointname" type="text" style="width: 200px;"></td>
							<td width="200"></td>
							<td width="200"></td>
						</tr>
						<tr id="remarksDiv">
							<td><label><fmt:message key="lms.description"/>:</label></td>
							<td colspan="3">
...
<sitemesh:script>
<script src="${pageContext.request.contextPath}/js/manager/question/knowledgepointEdit_dlg.js?version=${version}"></script>
<script>
</script>
</sitemesh:script>
</html>