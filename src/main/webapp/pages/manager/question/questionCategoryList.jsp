...
<html lang="en">
<head>
	<title><fmt:message key="lms.questionCategoryMaintenance"/></title>
	<style type="text/css">
		#searchForm td {
			white-space:nowrap; 
		}
		...
		<div class="col-md-12">
			<div class="portlet box blue-hoki nomargin">
				<div class="portlet-title">
					<div class="caption">
					<i class="fa fa-building"></i><fmt:message key="lms.questionCategoryMaintenance"/>
					</div>
				</div>
										...
										<tbody>
											<tr>
												<td class="formlable" width="8.5%">
													<fmt:message key="lms.questionCategoryName"/>
                                                </td>
                                                <td class="formbody" width="11.5%">
                                                	<input id="parentid" name="parentid" type="hidden" value="0"/>
                                                    <input id="categoryname" name="categoryname" class="form-control input-sm select2" type="text" style="width: 200px;"/>
                                                </td>
			...
			<div class="portlet box blue-hoki nomargin ">
				<div class="portlet-title">
					<div class="caption" id="typeCaption"><fmt:message key="lms.questionCategoryList"/>
					</div>
					<div class="actions">
								...
								<table id="listTable" class="table table-hover">
									<thead>
										<tr>
											...
											<th width="15%"><fmt:message key="lms.questionCategoryName"/></th>
...
<sitemesh:script>
<script src="${pageContext.request.contextPath}/js/manager/question/questionCategoryList.js?version=${version}"></script>
<script>
//试题分类新增
var fmtQuestionCategoryAdd = '<fmt:message key="lms.questionCategoryAdd"/>';
//试题分类二级新增
var fmtQuestionCategorySecondLevelAdd = '<fmt:message key="lms.questionCategorySecondLevelAdd"/>';
//试题分类编辑
var fmtQuestionCategoryEdit = '<fmt:message key="lms.questionCategoryEdit"/>';
//试题分类二级编辑
var fmtQuestionCategorySecondLevelEdit = '<fmt:message key="lms.questionCategorySecondLevelEdit"/>';
//试题分类列表
var fmtQuestionCategoryList = '<fmt:message key="lms.questionCategoryList"/>';
//试题分类二级列表
var fmtQuestionCategorySecondLevelList = '<fmt:message key="lms.questionCategorySecondLevelList"/>';
//试题分类名称
var fmtQuestionCategoryName = '<fmt:message key="lms.questionCategoryName"/>';
//不能为空
