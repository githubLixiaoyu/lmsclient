...
<html lang="en">
<head>
	<title><fmt:message key="lms.rankingDisplay"/></title>
	<style type="text/css">
		#searchForm td {
			white-space:nowrap; 
		}
		...
		<div class="col-md-12">
			<div class="portlet box blue-hoki nomargin">
				<div class="portlet-title">
					<div class="caption">
					<i class="fa fa-building"></i><fmt:message key="lms.rankingDisplay"/>
					</div>
				</div>
			...
			<div class="portlet box blue-hoki nomargin ">
				<div class="portlet-title">
					<div class="caption" id="typeCaption"><fmt:message key="lms.rankingList"/>
					</div>
					<div class="actions">
<!-- 						<button type="button" id="viewCommentBtn" class="btn btn-success"> -->
<!-- 							<i class="fa fa-upload"></i> 查看评论 -->
<!-- 						</button> -->
					</div>
				</div>
						...
						<div class="table-responsive">
							<div class="tabbable-custom ">
								<table id="listTable" class="table table-hover">
									<thead>
										<tr>
											<th width="5%"><fmt:message key="lms.orderNum"/></th>
											<th width="15%"><fmt:message key="lms.nickName"/></th>
											<th width="15%"><fmt:message key="lms.totalScore"/></th>
											<th width="15%"><fmt:message key="lms.updateTime"/></th>
										</tr>
									</thead>
									<tbody>
									</tbody>
...
<sitemesh:script>
<script src="${pageContext.request.contextPath}/js/manager/ranking/rankingList.js?version=${version}"></script>
</sitemesh:script>
</html>