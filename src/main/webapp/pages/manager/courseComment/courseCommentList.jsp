...
<html lang="en">
<head>
	<title><fmt:message key="lms.courseDiscussMaintenance"/></title>
	<style type="text/css">
		#searchForm td {
			white-space:nowrap; 
		}
		...
		<div class="col-md-12">
			<div class="portlet box blue-hoki nomargin">
				<div class="portlet-title">
					<div class="caption">
					<i class="fa fa-building"></i><fmt:message key="lms.courseDiscussMaintenance"/>
					</div>
				</div>
			...
			<div class="portlet box blue-hoki nomargin ">
				<div class="portlet-title">
					<div class="caption" id="captionSpan"><fmt:message key="lms.courseDiscussList"/>(<%=request.getParameter("coursename") %>)
					</div>
					<div class="actions">
...
<sitemesh:script>
<script src="${pageContext.request.contextPath}/js/manager/courseComment/courseCommentList.js?version=${version}"></script>
<script>
//状态 正在创建
