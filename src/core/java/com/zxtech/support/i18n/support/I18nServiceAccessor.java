package com.zxtech.support.i18n.support;

import java.io.Serializable;
import java.util.Locale;
import java.util.Map;

import com.zxtech.support.i18n.I18nService;
import com.zxtech.support.i18n.LocaleContextHolder;
import com.zxtech.support.i18n.NoSuchMessageException;
...
public class I18nServiceAccessor implements Serializable {
	...
	public Map<String, Object> getAllMessage(Locale locale)
			throws NoSuchMessageException {
		return this.i18nService.getAllMessage(locale);
	}
